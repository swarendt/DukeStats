...
I am using the mutate function to create a new column that will identify each respondent in a category.  
...
```{r q1results}
# original.parameters<-par() # Preserve original parameters, about to modify to improve graph

table(sleepANDhealth$sleepcat)
# par(yaxt="n")
plot(sleepANDhealth$sleepcat, sleepANDhealth$genhlth,  
       xlab = "Hours of Sleep", 
        ylab = "Feeling of Health")

# lablist.y<-as.vector(c("Excellent", "Very Good", "Good", "Fair", "Poor"))
# text(labels = lablist.y, srt = 45, pos = 2, xpd = TRUE)
